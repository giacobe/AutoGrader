...
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# OMR Reader - version alpha1.18
__version__ = "alpha1.18"

"""
AutoGrader Alpha 1.16
...
def process_one_page(pdf_path, dpi, page_index,
    ...
    print(f"[Alpha1.16] page={page_index+1} form={form_letter} email={email_loc} "
...
def main():
    ap = argparse.ArgumentParser("OMR (multi-page, design-aligned export) — Alpha1.16")
